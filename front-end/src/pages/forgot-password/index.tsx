            ...
            <form className="forgot-password-main-form" onSubmit={onSubmit}>
              ...
              <div className="forgot-password-main-form-group">
                <div className="forgot-password-main-form-group-infor">
                  <label
                    className="forgot-password-main-form-group-infor-title"
                    htmlFor="email"
                  >
                    Nhập email của bạn:
                  </label>
                  <input
                    {...register("email")}
                    className="forgot-password-main-form-group-infor-input"
                    type="email"
                    id="email"
                  />
                </div>
                {errors.email && (
                  <p className="forgot-password-main-form-group-error">
              ...
              <div className="forgot-password-main-form-submit">
                ...
                <button
                  className="forgot-password-main-form-submit-button"
                  type="submit"
                >
                  Gửi
                </button>
              ...
              <div className="forgot-password-main-form-submit-login">
                <p>
                  <Link
                    to="/auth/login"
                    replace={false}
                    className="forgot-password-main-form-submit-link"
                  >
                    Quay lại đăng nhập
                  </Link>
                </p>
