...
const ChangePassword = () => {
    ...
    const handleForgotPassword = () => {
        Swal.fire({
            ...
            text: "Mật khẩu mới sẽ được gửi về email của bạn",
            icon: 'warning',
            ...
            if (result.isConfirmed) {
                Swal.fire(
                    'Hoàn thành!',
                    'Kiểm tra mật khẩu mới trong email',
                    'success'
                )
            }
        })
        ...
        <>
            <div className="profile-user-main-details">
                <div className="profile-user-main-details-upper">
                    <h3 className="profile-user-main-details-upper-title">Đổi Mật Khẩu</h3>
                ...
                <div className="profile-user-main-details-lower">
                    <div className="profile-user-main-details-lower-left">
                        <form className="profile-user-main-details-lower-left-form" onSubmit={onSubmit}>
                            <div className="profile-user-main-details-lower-left-form-group">
                                <label htmlFor="password" className="profile-user-main-details-lower-left-form-group-label">
                                    Mật khẩu hiện tại:
                                </label>
                                <input {...register("password")} id="password" type="password" />
                            </div>
                            <div className="profile-user-main-details-lower-left-form-group">
                                <label htmlFor="new-password" className="profile-user-main-details-lower-left-form-group-label">
                                    Mật khẩu mới:
                                </label>
                                <input {...register("newPassword")} id="new-password" type="password" />
                            </div>
                            <div className="profile-user-main-details-lower-left-form-group">
                                <label htmlFor="verify-password" className="profile-user-main-details-lower-left-form-group-label">
                                    Xác nhận mật khẩu mới:
                                </label>
                                <input {...register("verifyNewPassword")} id="verify-password" type="password" />
                            </div>
