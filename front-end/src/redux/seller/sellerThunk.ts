  ...
  async (userInfor: RegisterSellerValue) => {
    try {
      const response = await axios.post(
        `${REACT_APP_ROOT_API}/seller/accept`,
        userInfor
      );
      return response;
    } catch (error: any) {
...
export const getProductSeller = createAsyncThunk(
  ...
  async (request: GetProductSeller) => {
    try {
      const response = await axios.post(
        `${REACT_APP_ROOT_API}/product/seller`,
        request
      );
      return response;
    } catch (error: any) {
...
export const removeProductSeller = createAsyncThunk(
  ...
  async (request: RemoveProductSeller) => {
    try {
      const response = await axios.post(
        `${REACT_APP_ROOT_API}/product/delete`,
        request
      );
      return response;
    } catch (error: any) {
...
export const addProductSeller = createAsyncThunk(
  ...
  async (request: AddProductSeller) => {
    try {
      const response = await axios.post(
        `${REACT_APP_ROOT_API}/product/add`,
        request
      );
      return response;
    } catch (error: any) {
...
export const updateProductSeller = createAsyncThunk(
  ...
  async (request: AddProductSeller) => {
    try {
      const response = await axios.post(
        `${REACT_APP_ROOT_API}/product/update`,
        request
      );
...
export const gelAllOrderSeller = createAsyncThunk(
  ...
  async (request: GelAllOrderSeller) => {
    try {
      const response = await axios.post(
        `${REACT_APP_ROOT_API}/order/orderSeller`,
        request
      );
      return response.data;
    } catch (error: any) {
...
export const updateStatusSeller = createAsyncThunk(
  ...
  async (request: UpdateStatusSeller) => {
    try {
      const response = await axios.post(
        `${REACT_APP_ROOT_API}/order/update`,
        request
      );
      return response.data;
    } catch (error: any) {
...
export const historySeller = createAsyncThunk(
  "order/history",
  async (request: any) => {
    try {
      const response = await axios.post(
        `${REACT_APP_ROOT_API}/order/complete`,
        request
      );
      return response.data;
    } catch (error: any) {
